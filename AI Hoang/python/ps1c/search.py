    ...
    while not fringe.isEmpty():
      ...
      for successor in problem.getSuccessors(node[0]):
          if not successor[0] in visited:
              ss = list(node[1])
              ss.append(successor[1])
              fringe.push((successor[0], ss , successor[2]))
        ...
        for successor in problem.getSuccessors(node[0]):
            if not successor[0] in visited:
                if (not successor[0] in succeeded) or (problem.isGoalState(successor[0])):
                    ...
                    fringe.push((successor[0], ss, successorCost), successorCost)
        ...
        for successor in problem.getSuccessors(node[0]):
            if not successor[0] in visited:
                if (not successor[0] in succeeded) or (problem.isGoalState(successor[0])):
                    ...
                    ssHeuristic = heuristic(successor[0], problem)
                    scsh = cost + ssHeuristic
                    fringe.push((successor[0], ss, cost), scsh)
