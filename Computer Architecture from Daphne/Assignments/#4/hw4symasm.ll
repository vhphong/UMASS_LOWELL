...
#define         LOC	  28
#define         STR       29
#define         MULT	  30    //MULT definition is added
#define         RSHIFT	  31	//RSHIFT definition is added
#define         DIV       32    //DIV definition is added
%}
...
[Mm][Uu][Ll][Tt]                       return(MULT);    //MULT char checker is added

[Rr][Ss][Hh][Ii][Ff][Tt]               return(RSHIFT);  //RSHIFT char checker is added

[Dd][Ii][Vv]                           return(DIV);     //DIV char checker is added
