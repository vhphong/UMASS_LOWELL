...
def graph_and_compare_clustcf():
    ...
    print('Snap Clustering Coefficient for Small World Network: %f' % snap.GetClustCf(small_world, -1))
    print('Snap Clustering Coefficient for Collaboration Network: %f' % snap.GetClustCf(collab_net, -1))


def main():
    graph_and_compare_clustcf()
